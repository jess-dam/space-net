                ...
                data && (
                    ...
                    data.map((item) =>
                        <div>
                            ...
                            <p>Close approach to Earth date: {item.close_approach_data[0].close_approach_date}</p>
                            <p>Velocity: {Math.round(item.close_approach_data[0].relative_velocity.kilometers_per_hour)}km/h</p>
                            <p>Missing impact with Earth by: {Math.round(item.close_approach_data[0].miss_distance.kilometers)}km</p>
                            <br></br>
                        </div>
                    )
